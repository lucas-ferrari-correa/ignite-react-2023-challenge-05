...
declare const Heading: _stitches_react_types_styled_component.StyledComponent<"h2", {
    size?: "sm" | "md" | "lg" | "xl" | "2xl" | "4xl" | "5xl" | "3xl" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
...
declare const TooltipContainer: _stitches_react_types_styled_component.StyledComponent<react.FC<Tooltip$1.TooltipProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type HeadingProps, Multistep, type MultistepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Tooltip, type TooltipProps };
